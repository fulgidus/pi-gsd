...
```bash
INIT=$(node ".claude/get-shit-done/bin/gsd-tools.cjs" init manager)
...
2. Run: node \".claude/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
2. Run: node \".claude/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
