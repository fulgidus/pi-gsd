...
See .windsurf/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .windsurf/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using .windsurf/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .windsurf/get-shit-done/templates/discovery.md
...
Use .windsurf/get-shit-done/templates/discovery.md.
