...
<!-- For checkpoint task examples and patterns, see @.windsurf/get-shit-done/references/checkpoints.md -->
...
See `.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
